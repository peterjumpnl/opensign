...
<div class="max-w-4xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow overflow-hidden sm:rounded-lg p-6">
        ...
        <h1 class="text-2xl font-bold text-center text-gray-900 mb-6">Thank You for Signing!</h1>
        
        <div class="text-center mb-8">
            <p class="text-gray-600 mb-4">
                You have successfully signed the document <span class="font-semibold">{{ $document->title }}</span>.
            </p>
            <p class="text-gray-600">
                A confirmation email will be sent to <span class="font-semibold">{{ $signer->email }}</span> once all parties have completed signing.
            </p>
        </div>

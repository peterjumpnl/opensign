...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('documents.create') }}" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Upload New Document
        </a>
    </div>
    ...
    @if($documents->isEmpty())
        <div class="bg-gray-100 rounded-lg p-8 text-center">
            ...
            <a href="{{ route('documents.create') }}" class="text-blue-600 hover:text-blue-800 font-medium">

...
<div class="container mx-auto px-4 py-8">
    <div class="flex items-center mb-6">
        <a href="{{ route('documents.index') }}" class="text-blue-600 hover:text-blue-800 mr-2">
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('documents.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                <label for="file" class="block text-gray-700 text-sm font-bold mb-2">PDF Document *</label>
            ...
            <div class="flex items-center justify-end">
                <a href="{{ route('documents.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded mr-2">
                    Cancel
                </a>
